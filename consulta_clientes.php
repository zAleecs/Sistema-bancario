    ...
    <script>
        $(document).ready(function () {
            ...
            $('#tablaClientes').on('click', '.editar', function() {
                ...
                window.location.href = 'editar_clientes.php?id=' + id; // Redirige al archivo de edición
            });
            ...
            $('#tablaClientes').on('click', '.eliminar', function() {
                ...
                if (confirm('¿Estás seguro de que deseas eliminar este registro?')) {
                    window.location.href = 'eliminar_clientes.php?id=' + id; // Redirige al archivo de eliminación
                }
            });
        });
    </script>
